export function buildSvg(streak, { width = 800, height = 450, padding = 20, gifUrl = 'http://localhost:3000/goku.gif' } = {}) {
  const days = streak.day_count;

  return `
  <svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <image href="${gifUrl}" xlink:href="${gifUrl}" x="0" y="0" width="${width}" height="${height}" preserveAspectRatio="xMidYMid slice"/>
