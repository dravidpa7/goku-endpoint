export function buildSvg(streak, { width = 400, height = 200, padding = 20 } = {}) {
  const days = streak.day_count;

  return `
 <svg id="fire-svg" viewBox="0 0 600 700" class="w-full h-full overflow-visible drop-shadow-[0_10px_35px_rgba(255,60,0,0.25)]" xmlns="http://www.w3.org/2000/svg"><style>
